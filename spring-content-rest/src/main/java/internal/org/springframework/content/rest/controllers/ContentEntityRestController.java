...
public class ContentEntityRestController extends AbstractContentPropertyController {
	...
	@Autowired
	public ContentEntityRestController(ApplicationContext context, ContentStoreService storeService,
	...
	@RequestMapping(value = BASE_MAPPING, method = RequestMethod.GET, headers = { "accept!=application/hal+json",
			"range" })
	public void getContent(HttpServletRequest request, HttpServletResponse response, @PathVariable String store,
		...
		if (BeanUtils.hasFieldWithAnnotation(domainObj, MimeType.class)) {
			request.setAttribute("SPRING_CONTENT_CONTENTTYPE",
					BeanUtils.getFieldWithAnnotation(domainObj, MimeType.class).toString());
		}
	...
	public ResponseEntity<InputStreamResource> getContent(@PathVariable String store, @PathVariable String id,
	...
	@ResponseBody
	public void putContent(HttpServletRequest request, HttpServletResponse response, @PathVariable String store,
	...
	@RequestMapping(value = BASE_MAPPING, method = RequestMethod.PUT, headers = "content-type=multipart/form-data")
	@ResponseBody
	public void putMultipartContent(HttpServletResponse response, @PathVariable String store, @PathVariable String id,
	...
	@ResponseBody
	public void postMultipartContent(HttpServletResponse response, @PathVariable String store, @PathVariable String id,
			@RequestParam("file") MultipartFile multiPart)
			throws IOException, HttpRequestMethodNotSupportedException, InstantiationException, IllegalAccessException {
		handleMultipart(response, store, id, multiPart);
	}
	...
	public void deleteContent(HttpServletResponse response, @PathVariable String store, @PathVariable String id)
