	package internal.com.emc.spring.content.s3.store;
...
public class DefaultS3RepositoryImpl<S, SID extends Serializable> implements ContentStore<S,SID> {
	...
	private static Log logger = LogFactory.getLog(DefaultS3RepositoryImpl.class);
	
	private ResourceLoader resourceLoader;
	private AmazonS3 client;
	private String bucket;

	public DefaultS3RepositoryImpl(ResourceLoader resourceLoader, AmazonS3 client, Region region, String bucket) {
