...
public class DefaultS3StoreImpl<S, SID extends Serializable>
   ...
   *          S3 bucket name.
   */
  public DefaultS3StoreImpl(ResourceLoader loader, ConversionService converter, AmazonS3 client,
      String bucket) {
    this.loader = loader;
  ...
  public void setContent(S property, InputStream content) {
    ...
    try {
      ...
      logger.error(String.format("Unexpected error setting content length for content %s",
