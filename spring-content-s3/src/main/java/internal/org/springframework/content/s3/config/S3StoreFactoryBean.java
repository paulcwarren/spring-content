...
public class S3StoreFactoryBean extends AbstractStoreFactoryBean {
	...
	@Autowired
	public S3StoreFactoryBean(AmazonS3 client, PlacementService s3StorePlacementService, S3ObjectIdResolvers resolvers) {
		this.client = client;
...
//		}
		...
		return new DefaultS3StoreImpl(loader, s3StorePlacementService, client/*, resolver, bucket*/);
	}
}
