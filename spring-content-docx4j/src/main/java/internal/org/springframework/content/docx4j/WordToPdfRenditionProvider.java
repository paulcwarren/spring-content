...
public class WordToPdfRenditionProvider implements RenditionProvider {
	...
	public RenditionCapability isCapable(String fromMimeType, String toMimeType) {
		if (MimeType.valueOf(toMimeType).includes(MimeType.valueOf("application/pdf")) && consumes(fromMimeType))
	...
	public Resource convert(Resource fromInputSource, String toMimeType) {
		try {
			...
			// Mac
			// String
			// regex=".*(Courier New|Arial|Times New Roman|Comic Sans|Georgia|Impact|Lucida
			// Console|Lucida Sans Unicode|Palatino
