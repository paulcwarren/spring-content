...
public class StringBasedUUIDPlacementStrategyTest {

	private StringBasedUUIDPlacementStrategy strategy;
	...
	{
		Describe("StringBasedUUIDPlacementStrategy", () -> {
			BeforeEach(() -> {
				strategy = new StringBasedUUIDPlacementStrategy();
			});
			JustBeforeEach(() -> {
				try {
			...
			Context("#getLocation", () -> {
				...
				Context("given a contentId", () -> {
					BeforeEach(() -> {
						contentId = "d0689992-14ac-11e7-93ae-92361f002671";
					});
