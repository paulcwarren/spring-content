...
public abstract class AbstractStoreBeanDefinitionRegistrar
	...
	protected void registerContentStoreBeanDefinitions(
		...
		AnnotationAttributes attributes = new AnnotationAttributes(importingClassMetadata
				.getAnnotationAttributes(getAnnotation().getName()));
		...
		Set<GenericBeanDefinition> definitions = StoreUtils
				.getStoreCandidates(resourceLoader, basePackages);
		...
		for (BeanDefinition definition : definitions) {
			...
			builder.addPropertyValue(STORE_INTERFACE_PROPERTY,
