...
public final class BeanUtils {
	...
	public static Object getFieldValue(Object domainObj, Field field) throws SecurityException, BeansException {
		Object value = null;
	 ...
	 *            the value to set
	 */
	public static void setFieldWithAnnotation(Object domainObj, Class<? extends Annotation> annotationClass,
			Object value) {
		setFieldWithAnnotationConditionally(domainObj, annotationClass, value, MATCHING_CONDITION);
	}

	/**
	 * Sets object's field annotated with annotationClass to value only if the
	 * condition matches.
	 *
	 * @param domainObj
	 *            the object containing the field
	...
	public static void setFieldWithAnnotationConditionally(Object domainObj,
			Class<? extends Annotation> annotationClass, Object value, Condition condition) {
