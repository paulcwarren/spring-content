package com.emc.spring.content.commons.config;
...
import internal.com.emc.spring.content.commons.renditions.RenditionServiceImpl;
import internal.com.emc.spring.content.commons.storeservice.ContentStoreServiceImpl;
...
public abstract class AbstractContentStoreBeanDefinitionRegistrar implements ImportBeanDefinitionRegistrar, ResourceLoaderAware, BeanFactoryAware {
	...
	private static String REPOSITORY_INTERFACE_POST_PROCESSOR = "internal.com.emc.spring.content.commons.utils.ContentRepositoryInterfaceAwareBeanPostProcessor";
