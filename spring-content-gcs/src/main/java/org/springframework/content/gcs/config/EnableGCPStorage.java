...
import internal.org.springframework.content.gcs.config.GCPStorageConfiguration;
import internal.org.springframework.content.gcs.config.GCPStorageFactoryBean;
import internal.org.springframework.content.gcs.config.GCPStorageRegistrar;

@Target(ElementType.TYPE)
@Retention(RetentionPolicy.RUNTIME)
@Documented
@Inherited
@Import({ GCPStorageConfiguration.class, GCPStorageRegistrar.class })
public @interface EnableGCPStorage {
	 ...
	 * Defaults to {@link GCPStorageFactoryBean}.
	 *
	 * @return s3 store factory bean
	 */
	Class<?> storeFactoryBeanClass() default GCPStorageFactoryBean.class;
}
