...
@Documented
@Inherited
@Import({ GCSStoreConfiguration.class, GCSStoresRegistrar.class })
public @interface EnableGCSStores {
	 ...
	 * instance. Defaults to {@link GCSStoreFactoryBean}.
	 *
	 * @return GCS store factory bean
	 */
